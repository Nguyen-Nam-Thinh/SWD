      ...
      <header className="fixed w-full top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b border-slate-200 p-4 space-y-4">
            <a href="#" className="block text-slate-600 font-medium">Tính năng</a>
            <a href="#" className="block text-slate-600 font-medium">Giải pháp</a>
            <Link to="/login" className="block text-blue-600 font-bold">Đăng nhập ngay</Link>
          </div>
        )}
      </header>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <p className="text-lg text-slate-600 max-w-xl leading-relaxed">
                Unica Finance giúp doanh nghiệp của bạn kiểm soát tài chính, tự động hóa báo cáo và dự báo dòng tiền bằng công nghệ AI tiên tiến nhất.
              </p>
      ...
      <section className="py-24 bg-white" id="features">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Mọi thứ bạn cần để phát triển</h2>
            <p className="text-slate-600">Hệ thống của chúng tôi cung cấp các công cụ mạnh mẽ nhất để bạn quản lý tài chính mà không cần kiến thức kế toán chuyên sâu.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-200 hover:shadow-xl transition-all group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Phân tích thời gian thực</h3>
              <p className="text-slate-600 leading-relaxed">
                Theo dõi biến động dòng tiền ngay lập tức với các biểu đồ trực quan và báo cáo tự động cập nhật từng giây.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-200 hover:shadow-xl transition-all group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Bảo mật cấp ngân hàng</h3>
              <p className="text-slate-600 leading-relaxed">
                Dữ liệu của bạn được mã hóa 256-bit chuẩn AES. Chúng tôi tuân thủ các tiêu chuẩn bảo mật khắt khe nhất.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-200 hover:shadow-xl transition-all group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Thanh toán toàn cầu</h3>
              <p className="text-slate-600 leading-relaxed">
                Hỗ trợ đa tiền tệ và cổng thanh toán quốc tế, giúp doanh nghiệp của bạn vươn ra biển lớn dễ dàng.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 font-bold text-xl text-white mb-4">
              <div className="w-6 h-6 bg-blue-600 rounded flex items-center justify-center text-white text-xs">U</div>
              UNICA FINANCE
            </div>
            <p className="text-sm max-w-xs">
              Đồng hành cùng sự thịnh vượng của doanh nghiệp Việt. Giải pháp tài chính số 1 thị trường.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-white">Báo cáo thuế</a></li>
              <li><a href="#" className="hover:text-white">Quản lý nhân sự</a></li>
            </ul>
          </div>
